...
function() {
    ...
    describe('store', function () {
        it('should clear the nodes/links when set to null', function () {
            var layoutDone;
            ...
            runs(function () {
                expect(component.getRenderedNodes().size()).toBeGreaterThan(0);
                expect(component.getRenderedLinks().size()).toBeGreaterThan(0);
                component.setStore(null);
                expect(component.getRenderedNodes().size()).toBe(0);
                expect(component.getRenderedLinks().size()).toBe(0);
            });
        });
    });
